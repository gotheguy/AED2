...
public class Arbol {
    ...
    public void mostrarPreOrder(Nodo a){
        if (a!=null){
            System.out.print(a.getDato().getCedula()+"   ");
    ...
    public String InOrderlistarProductores() 
    {
        String ret = "";
    ...
    public void mostrarPosOrder(Nodo a){
        ...
        public boolean existeProductor(String cedula) {
            ...
            Nodo nodo = null;
            nodo = obtenerProductorPorCedula(cedula, this.raiz);
		
            return nodo != null;
	}
    
        
        public Nodo obtenerProductorPorCedula(String cedula, Nodo nodo) {
            if(nodo == null) {
                return nodo;
            } else {
                    if(cedula.compareTo(nodo.getDato().getCedula()) == 0) 
                    {
                        return nodo;
                    } 
                    else if (cedula.compareTo(nodo.getDato().getCedula()) < 0)
                              return obtenerProductorPorCedula(cedula, nodo.getIzq());
                         else 
                              return obtenerProductorPorCedula(cedula, nodo.getDer());
            }
	}
    ...
    public void insertarElemento(Productor p, Nodo nodo) {
        ...
        else if (p.getCedula().compareTo(nodo.getDato().getCedula()) < 0)
